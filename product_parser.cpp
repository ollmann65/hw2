...
{
return new Book(prodName_, price_, qty_, isbn_, author_); //1
...
return new Clothing(prodName_, price_, qty_, size_, brand_); //2
...
{
return new Movie(prodName_, price_, qty_, genre_, rating_); // 3
